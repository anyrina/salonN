...
<header id="header" class="header_flex">
    <div  class="name_header">
        <p id="name_header">FACE & BODY ESTHETIC<br>
    ...
    <div class="menus_header">
        <ul class="header_flex">
            ...
            <li><a class="button_header menu_header0" href="./menu.html">MENU</a></li>
            <li class="header_menu_none"><a class="button_header" href="./item.html">ITEM</a></li>
            <li class="header_menu_none"><a class="button_header" href="./shop.html">STORE INFO</a></li>
        </ul>
    </div>
    ...
    <div class="nav">
        ...
        <nav class="nav_content">
          <ul class="nav_list">
            ...
            <li class="nav_item header_menu_none"><a href="./item.html">ITEM</a></li>
            <li class="nav_item header_menu_none"><a href="./shop.html">INFO</a></li>
            </ul>
        </nav>
        ...
        <div class="office">
            ...
            <div class="footer_office_item">
                ...
                <div class="footer_office_info">
                    <a href="./index.html"><span class="footer_shop_name">salon N</span></a>
                    
                    <p>〒035-0031 青森県むつ市柳町4-3-9</p>
                    <table class="table_footer">
                        <tr><th>営業時間</th> <td>　9:00~17:00  /  夜間はお問い合わせ下さい</td></tr>
                        <tr><th>定休日</th> <td>　日曜・祝日</td></tr>
                        <tr><th>駐車場あり</th> <td>　1台</td></tr>
                        <tr><th>支払い方法</th> <td>　現金 / クレジット / スマホ決済 / 電子マネー</td></tr>
                    </table>

                    <div class="sns">
                        <a class="instagram" href="https://www.instagram.com/private__salon__n/"><span class="f-fa fa-brands fa-instagram" style="color: #f04bf0;"></span></a>
